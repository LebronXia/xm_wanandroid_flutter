...
part of 'knowledge_detail_list_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

KnowledgeDetailListModel _$KnowledgeDetailListModelFromJson(
  Map<String, dynamic> json,
) => KnowledgeDetailListModel(
  curPage: (json['curPage'] as num?)?.toInt(),
  datas:
      (json['datas'] as List<dynamic>?)
          ?.map((e) => KnowledgeDetailItem.fromJson(e as Map<String, dynamic>))
          .toList(),
...
Map<String, dynamic> _$KnowledgeDetailListModelToJson(
  KnowledgeDetailListModel instance,
) => <String, dynamic>{
